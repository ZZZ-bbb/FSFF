...
Official implementation of the paper: “Flexible spatial-frequency feature fusion for UAV-based semantic segmentation in rice phenotyping” Smart Agricultural Technology, 2025, 12: 101641
Zibin Zhou1, Xuan Wei1, Huasheng Huang*, Jiajun Zhuang, Peng Zhang, Tao Guo, Hong Liu, Zhiping Tan, Yu Tang*
1 Co-first authors. * Corresponding authors.
📄 Paper (ScienceDirect)
...
framework Figure 1. Overall workflow of the proposed FSFF framework.
✨ Highlights
